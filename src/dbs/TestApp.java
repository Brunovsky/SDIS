    ...
    public TestApp(String[] args) {
        ...
        if (this.operation == Operation.BACKUP || this.operation == Operation.RESTORE
            ...
            if (this.operation == Operation.BACKUP) {
                if (args.length >= 4) {
                    try {
                        ...
                        System.out.println("    The second operand " + args[3]
                                + " is not allowed. Should be an integer for the BACKUP operation.");
                        System.exit(1);
                    }
                }
            }
            ...
            try {
                ...
                System.out.println("    The first operand " + args[2]
                        + " is not allowed. Should be an integer for the RECLAIM operation.");
                System.exit(1);
            }
        }
    }
